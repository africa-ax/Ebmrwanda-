    ...
    mainContent.innerHTML = `
        <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <h2 style="color: #667eea;">🛒 Browse & Purchase Products</h2>
            ...
            <!-- Tabs: Browse Products vs My Orders -->
            <div style="display: flex; gap: 1rem; margin-bottom: 2rem; border-bottom: 2px solid #e0e0e0; padding-bottom: 0.5rem;">
                <button id="tabBrowse" class="tab-button active" onclick="showBrowseTab()">Browse Products</button>
                <button id="tabOrders" class="tab-button" onclick="showOrdersTab()">My Orders</button>
            </div>
            ...
            <div id="browseTab">
                ...
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <select id="sellerSelect" onchange="loadSellerProducts()" style="width: 100%; max-width: 400px;">
                ...
                <div id="productsList">
                    <div style="text-align: center; padding: 3rem; color: #999;">
                        <p>Select a seller to view their products</p>
                    </div>
                </div>
            </div>
...
/**
 * Load sellers based on who user can buy from
 */
...
function addToCart(sellerId, stockId, productId, productName, productSKU, productUnit, maxQuantity, pricePerUnit, vatRate) {
    ...
    const sellerRole = selectedOption.getAttribute('data-role');
